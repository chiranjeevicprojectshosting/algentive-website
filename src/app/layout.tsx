  ...
  return (
    <html lang="en">
      ...
      >
        <Header />
        {children}
        <footer className="w-full bg-black/80 text-white/80 py-10 mt-20 border-t border-white/10">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 px-6">
            <div className="flex flex-col items-center md:items-start gap-2">
              <div className="flex items-center gap-2 mb-2">
                <img src="/logo.png" alt="AlGentive Logo" width={40} height={40} className="logo-glow" />
                <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-500 bg-clip-text text-transparent">AlGentive</span>
              </div>
              <span className="text-sm">AI Innovation for Tomorrow</span>
            </div>
          ...
          <div className="text-center text-xs text-white/40 mt-6">&copy; {new Date().getFullYear()} AlGentive. All rights reserved.</div>
        </footer>
      </body>
    </html>
  );
